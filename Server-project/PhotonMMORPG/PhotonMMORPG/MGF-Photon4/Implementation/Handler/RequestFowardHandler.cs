...
namespace MGF_Photon.Implementation.Handler
{
    public class RequestFowardHandler : ServerHandler, IDefaultRequestHandler<IServerPeer>
    {
        ...
        public RequestFowardHandler(ILogger log, IConnectionCollection<IClientPeer> connectionCollection, ServerConfiguration serverConfiguration)
        {
            Log = log;
        ...
        {
            Log.DebugFormat("No existing Request Handler - RequestFowardHandler");
            return true;
        }
    }
}
