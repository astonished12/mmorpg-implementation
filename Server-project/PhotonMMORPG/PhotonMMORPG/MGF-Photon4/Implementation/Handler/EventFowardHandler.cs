...
{
    public class EventFowardHandler:ServerHandler,IDefaultEventHandler<IServerPeer>
    {
        ...
        public EventFowardHandler(ILogger log, IConnectionCollection<IClientPeer> connectionCollection, ServerConfiguration serverConfiguration, IClientCodeRemover clientCodeRemover)
        {
            Log = log;
        ...
        {
            Log.DebugFormat("Fowarding event {0} - {1}",message.Code,message.SubCode);
