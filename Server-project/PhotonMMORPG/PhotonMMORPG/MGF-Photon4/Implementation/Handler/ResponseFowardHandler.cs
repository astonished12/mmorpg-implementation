...
{
    public class ResponseFowardHandler:ServerHandler,IDefaultResponseHandler<IServerPeer>
    {
        ...
        public ResponseFowardHandler(ILogger log, IConnectionCollection<IClientPeer> connectionCollection, ServerConfiguration serverConfiguration, IClientCodeRemover clientCodeRemover)
        {
            Log = log;
        ...
        public override bool OnHandleMessage(IMessage message, IServerPeer serverPeer)
        {
            ...
            if (message.Parameters.ContainsKey(_serverConfiguration.PeerIdCode))
            {
                ...
                if (peer != null)
                {
                    ...
                    if (response != null)
                    {
                        peer.SendOperationResponse(new OperationResponse(message.Code, response.Parameters)
                        {
