...
{
    public class PhotonClientPeer : PeerBase, IClientPeer
    {
        public bool IsProxy
        {
            get { return false; }
        ...
        public delegate PhotonClientPeer ClientPeerFactory(IRpcProtocol protocol, IPhotonPeer photonPeer);
        ...
        public PhotonClientPeer(IRpcProtocol protocol,
            ...
            IHandlerList<IClientPeer> handlerList):base(protocol,photonPeer)
        {
            Log = log;
            _server = server;
