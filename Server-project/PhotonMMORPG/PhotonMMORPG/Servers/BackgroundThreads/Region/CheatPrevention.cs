...
{
    public class CheatPrevention : IBackgroundThread
    {
        private bool _isRunning;
        public ILogger Log { get; set; }
        public IConnectionCollection<IClientPeer> ConnectionCollection { get; set; }

        public CheatPrevention(IConnectionCollection<IClientPeer> connectionCollection, ILogger log) // Include IoC objects this thread needs i.e : IAreaRegion, IStats etc
        {
